...
public class TenUsers extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				driver5 = IntilizeDriver();
				driver5.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
				driver5.manage().timeouts().setScriptTimeout(60, TimeUnit.SECONDS);
				driver5.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
				wait5 = new WebDriverWait(driver5, 60);
				driver5.get(prop.getProperty("joinurl"));				
				Thread.sleep(2000);
				driver5.findElement(By.xpath("//input[@class='form-control']")).sendKeys(i);
				Thread.sleep(2000);
								driver5.findElement(By.xpath("//input[@class='joinBtn yellowBG mt-4 mb-4']")).click();			
				Thread.sleep(2000);
				driver5.findElement(By.xpath("(//div[@class='characterBlock position-relative'])[last()]")).click();
				Thread.sleep(2000);
				
				driver6 = IntilizeDriver();
				driver6.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
				driver6.manage().timeouts().setScriptTimeout(60, TimeUnit.SECONDS);
				driver6.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
				wait6 = new WebDriverWait(driver6, 60);
				driver6.get(prop.getProperty("joinurl"));				
				Thread.sleep(2000);
				driver6.findElement(By.xpath("//input[@class='form-control']")).sendKeys(i);
				Thread.sleep(2000);
								driver6.findElement(By.xpath("//input[@class='joinBtn yellowBG mt-4 mb-4']")).click();			
				Thread.sleep(2000);
				driver6.findElement(By.xpath("(//div[@class='characterBlock position-relative'])[last()]")).click();
				Thread.sleep(2000);
				
				driver7 = IntilizeDriver();
				driver7.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
				driver7.manage().timeouts().setScriptTimeout(60, TimeUnit.SECONDS);
				driver7.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
				wait7 = new WebDriverWait(driver7, 60);
				driver7.get(prop.getProperty("joinurl"));				
				Thread.sleep(2000);
				driver7.findElement(By.xpath("//input[@class='form-control']")).sendKeys(i);
				Thread.sleep(2000);
								driver7.findElement(By.xpath("//input[@class='joinBtn yellowBG mt-4 mb-4']")).click();			
				Thread.sleep(2000);
				driver7.findElement(By.xpath("(//div[@class='characterBlock position-relative'])[last()]")).click();
				Thread.sleep(2000);
				
				driver8 = IntilizeDriver();
				driver8.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
				driver8.manage().timeouts().setScriptTimeout(60, TimeUnit.SECONDS);
				driver8.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
				wait8 = new WebDriverWait(driver8, 60);
				driver8.get(prop.getProperty("joinurl"));				
				Thread.sleep(2000);
				driver8.findElement(By.xpath("//input[@class='form-control']")).sendKeys(i);
				Thread.sleep(2000);
								driver8.findElement(By.xpath("//input[@class='joinBtn yellowBG mt-4 mb-4']")).click();			
				Thread.sleep(2000);
				driver8.findElement(By.xpath("(//div[@class='characterBlock position-relative'])[last()]")).click();
				Thread.sleep(2000);
				}}}}