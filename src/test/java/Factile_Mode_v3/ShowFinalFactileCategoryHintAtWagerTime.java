...
public class ShowFinalFactileCategoryHintAtWagerTime extends Base {
	WebDriver driver;
	WebDriver driver1;
	WebDriverWait wait, wait1;
	int int2;
	String s6, s7, GameName, GameURL, twitterLink, PintrestLink, t1, p1, parent, expectedValue, actualValue,CategoryName= "Fantastic quiz";
	WebElement ElementGoingToVisible;
	Actions act;

	public static Logger Log = LogManager.getLogger(ShowFinalFactileCategoryHintAtWagerTime.class.getName());
	...
	@Test
	public void Show_Final_Factile_Category_Hint_at_Wager_Time()
	...
	public void modeaterscreen() throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[@class='swal2-confirm swal2-styled']")).click();
		Thread.sleep(2000);
		System.out.println(driver.findElement(By.xpath("//label[text()='Show Final Factile Category Hint At Wager Time']")).getText());

		WebElement s1 = driver.findElement(
				By.xpath("//label[contains(text(), 'Show Final Factile Category Hint At Wager Time')]/preceding-sibling::input[@type='checkbox']"));
		...
		Log.info("At customization page>> Check Show Final Factile Category Hint At Wager Time>> ");
	}
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", clickonedit);
		

		driver.findElement(By.xpath("//span[contains(text(),'Final Factile')]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@id='ffCustomCat']")).clear();
		Thread.sleep(3000);
		
		
		driver.findElement(By.xpath("//input[@id='ffCustomCat']")).sendKeys(CategoryName);
		Thread.sleep(3000);
		driver.findElement(By.xpath("//button[contains(text(),'SAVE')]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//p[contains(text(),'Play Game')]")).click();
		Thread.sleep(3000);
		/*
		 	Thread.sleep(3000);
				driver.findElement(By.xpath("//a[contains(text(),'Edit Game')]")).click();
				Thread.sleep(3000);
//driver.findElement(By.xpath("")).click();
		...
		executor2.executeScript("arguments[0].click();", clickonPlay);
		Thread.sleep(2000);
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				JavascriptExecutor executor6 = (JavascriptExecutor) driver1;
				executor6.executeScript("arguments[0].click();", JoinSubmit);
				Thread.sleep(2000);
				...
				driver.findElement(By.xpath("//span[contains(text(),'Begin Game')]")).click();
				Thread.sleep(3000);
				int TotalTiles = driver
						.findElements(
								By.xpath("//*[contains(@class,'gameQuestionBlock')]"))
						.size();

				for (int j = 1; j <= TotalTiles; j++) {
					
					 driver.findElement(By.xpath("(//*[contains(@class,'gameQuestionBlock')])[" + j + "]"))
						.click();
					Thread.sleep(2000);
				...
				Thread.sleep(2000);
			String Categname=	driver.findElement(By.xpath("//span[@id='ffCategoryHint']")).getText();
String actualcatgname= Categname.substring(12, 26);
System.out.println(actualcatgname);
