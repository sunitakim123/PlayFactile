...
public class SkipFinalFactile extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(SkipFinalFactile.class.getName());
	...
	@Test
	public void Skip_Final_Factile_checked_At_Global_Settings() throws InterruptedException, IOException {
	...
	public void modeaterscreen() throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[@class='swal2-confirm swal2-styled']")).click();
		Thread.sleep(2000);
		System.out.println(driver.findElement(By.xpath("//label[text()='Skip Final Factile']")).getText());

		WebElement s1 = driver.findElement(
				By.xpath("//label[contains(text(), 'Skip Final Factile')]/preceding-sibling::input[@type='checkbox']"));
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				System.out.println("Skip Final factile is working fine");
				Log.info("Skip Final Factile is working fine");
