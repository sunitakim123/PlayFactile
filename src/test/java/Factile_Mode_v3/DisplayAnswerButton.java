...
public class DisplayAnswerButton extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DisplayAnswerButton.class.getName());
	...
	@Test
	public void Display_Answer_Button_When_checked_At_Global_Settings() throws InterruptedException, IOException {
