...
public class GoProToSubscriptionBussinessYearlyData_Verify extends Base {
	WebDriver driver;
	int int2;
	Actions act;
	WebDriverWait wait;
	String Newgmailidsent;
	public static Logger Log = LogManager.getLogger(GoProToSubscriptionBussinessYearlyData_Verify.class.getName());
	...
	@Test
	public void GoProToBussinessYearlySubscriptionAndNextComingDate() throws InterruptedException, ParseException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[@id='yearlybusiness']")));
		WebElement enternumber = driver.findElement(By.xpath("//span[@id='yearlybusiness']"));
		...
		String dateExtracted = datecaptureFromAccountPage.substring(56, 67);
