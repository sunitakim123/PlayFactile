...
public class VerifyGamePointSymbolAfterDollar extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(VerifyGamePointSymbolAfterDollar.class.getName());
	...
	@Test
	public void Verify_Game_Point_Symbol_After__$() throws InterruptedException, IOException {
	...
	public void modeaterscreen() throws InterruptedException {
		...
		Thread.sleep(3000);
		Select dropdown = new Select(driver.findElement(By.xpath("(//select[@class='selectBox custom-select'])[7]")));
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				//200$
				String actualcustomsymbol= scoreInsidePodiumAtEnd.substring(3,4);
				...
				Log.info("Game_Point_Symbol_After_$ is working fine");
				System.out.println("Game_Point_Symbol_After_$ is working fine");
