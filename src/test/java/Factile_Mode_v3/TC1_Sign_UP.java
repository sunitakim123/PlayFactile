...
public class TC1_Sign_UP extends Base{
	WebDriver driver;	
	int int2;
	Actions act;
	WebDriverWait wait;
	String  Newgmailidsent;
	public static Logger Log = LogManager.getLogger(TC1_Sign_UP.class.getName());
	...
	public void SignUP_Verify() throws InterruptedException
	{
		...
		String GmailAfterLogin=driver.findElement(By.xpath("//span[@class='showEmail font-bold navbar-text']")).getText();
