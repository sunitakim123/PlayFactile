...
public class PlayAsJeopardyStyle extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(PlayAsJeopardyStyle.class.getName());
	...
	@Test
	public void PlayAsNumberedTiles_Instead_Of_JeopardyStyle_Unchecked_At_Global_Settings() throws InterruptedException, IOException {
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				Log.info("Play as Jeopardy Style");
				System.out.println("Play as Jeopardy Style");
