...
public class GoProToSubscriptionBussinessMonthlyData_Verify extends Base {
	WebDriver driver;
	int int2;
	Actions act;
	WebDriverWait wait;
	String Newgmailidsent;
	public static Logger Log = LogManager.getLogger(GoProToSubscriptionBussinessMonthlyData_Verify.class.getName());
	...
	@Test
	public void GoProTBussinessMonthlySubscriptionAndNextComingDate() throws InterruptedException, ParseException {
