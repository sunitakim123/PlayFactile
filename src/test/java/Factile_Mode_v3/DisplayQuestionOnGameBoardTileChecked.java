...
public class DisplayQuestionOnGameBoardTileChecked extends Base {
	...
	public static Logger Log = LogManager.getLogger(DisplayQuestionOnGameBoardTileChecked.class.getName());
	...
	@Test
	public void Display_Question_On_GameBoardTie_When_checked_At_Global_Settings() throws InterruptedException, IOException {
	...
	public void modeaterscreen() throws InterruptedException {
		...
		Thread.sleep(2000);
		System.out.println(driver.findElement(By.xpath("//label[text()='Display Question On Game Board Tile']")).getText());

		WebElement s1 = driver.findElement(
				By.xpath("//label[contains(text(), 'Display Question On Game Board Tile')]/preceding-sibling::input[@type='checkbox']"));
