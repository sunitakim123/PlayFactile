...
public class SkipAndSeeAnswer extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(SkipAndSeeAnswer.class.getName());
	...
	@Test
	public void Verify_Skip_And_See_Answer() throws InterruptedException, IOException {
