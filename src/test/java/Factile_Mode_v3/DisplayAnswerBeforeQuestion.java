...
public class DisplayAnswerBeforeQuestion extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DisplayAnswerBeforeQuestion.class.getName());
	...
	@Test
	public void Verify_Answer_Before_Question() throws InterruptedException, IOException {
...
/*
	...
	public void modeaterscreen() throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[@class='swal2-confirm swal2-styled']")).click();
		Thread.sleep(2000);
		System.out.println(driver.findElement(By.xpath("//label[text()='Display Answer Before Question']")).getText());
		
		
		
		WebElement s1 = driver.findElement(
				By.xpath("//label[contains(text(), 'Display Answer Before Question')]/preceding-sibling::input[@type='checkbox']"));
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				Thread.sleep(4000);
				driver.findElement(By.tagName("//a[contains(text(),'Edit Game')]")).click();
				Thread.sleep(3000);
				...
				Thread.sleep(3000);
				String QuestionIS=	driver.findElement(By.xpath("//div[@class='text-content-wrapper']//p")).getText();
				System.out.println("Question is:-"+QuestionIS);
				Thread.sleep(2000);
				driver.findElement(By.xpath("//span[text()='Skip/See Answer']")).click();
				Thread.sleep(2000);
				String AnswerIS=	driver.findElement(By.xpath("//div[@class='text-content-wrapper']//p")).getText();
				System.out.println("Answer is:-"+AnswerIS);
			    Assert.assertNotSame(QuestionIS, AnswerIS);
				System.out.println("Skip/See Answer is working fine");
				Log.info("Skip/See Answer is working fine");
