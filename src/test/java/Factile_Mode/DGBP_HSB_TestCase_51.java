...
public class DGBP_HSB_TestCase_51 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_51.class.getName());
	...
	@Test
	public void TC_51_Verify_Final_factile_Answer_text_box_with_specialcharacters() throws InterruptedException, IOException {
