...
public class DGBP_HSB_TestCase_47 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_47.class.getName());
	...
	@Test
	public void TC_47_Verify_wager_submit_by_moderator_is_zero() throws InterruptedException, IOException {
