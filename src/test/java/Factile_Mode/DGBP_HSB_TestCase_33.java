...
public class DGBP_HSB_TestCase_33 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_33.class.getName());
	...
	@Test
	public void TC_33_Stop_Timer_on_BuzzIn_of_1_to_100() throws InterruptedException, IOException {
	...
	public void modeaterscreen() throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//select[@id='stopTimerOnBuzzInOf']")));
		Select noumberofuser = new Select(driver.findElement(By.xpath("//select[@id='stopTimerOnBuzzInOf']")));
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			...
			String 	fetchingtimerstoppeduser1=driver1.findElement(By.xpath("//div[@class='questionBoardTitletimer animated animate zoomIn']//span")).getText();
			System.out.println("Timmer stoped at user first screen"+fetchingtimerstoppeduser1);
			...
			String 	fetchingtimerstoppeduser2=driver2.findElement(By.xpath("//div[@class='questionBoardTitletimer animated animate zoomIn']//span")).getText();
			System.out.println("Timmer stoped at user second screen"+fetchingtimerstoppeduser2);
					//Assert.assertEquals(fetchingtimerstoppeduser1, fetchingtimerstoppeduser2);
