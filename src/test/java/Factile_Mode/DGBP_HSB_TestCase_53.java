...
public class DGBP_HSB_TestCase_53 extends Base {
	...
	@Test
	public void TC_53_Verify_Final_factile_Answer_submitted_by_Team_Member() throws InterruptedException, IOException {
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				System.out.println("Final factile answer submit by Team Member=" + expectedtext);
				driver2.findElement(By.xpath("//textarea[@placeholder='Enter Answer']")).sendKeys(expectedtext);
				wait2.until(ExpectedConditions
						.elementToBeClickable(By.xpath("//input[@class='ansSubmitBtn btn--inside uppercase']")));
				driver2.findElement(By.xpath("//input[@class='ansSubmitBtn btn--inside uppercase']")).click();
