...
public class DGBP_HSB_TestCase_15 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_15.class.getName());
	...
	@Test
	public void TC_15_Verify_Game_Point_Symbol_$__Before() throws InterruptedException, IOException {
