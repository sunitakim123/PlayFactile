...
public class DGBP_HSB_TestCase_13 extends Base {
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_13.class.getName());
	...
	@Test
	public void TC_13_Verify_Play_as_Jeopardy_Style() throws InterruptedException, IOException {
	...
	public void modeaterscreen() throws InterruptedException {
		...
		Thread.sleep(3000);// checking the exact case at player screen on gameboard
	...
	Log.info("At customization page>> Play as Numbered Tiles instead of Jeopardy-style is unchecked >> ");
			...
			if (!parent.equalsIgnoreCase(child)) {
				...
				{ 
					...
					String actual= driver.findElement(By.xpath("(//span[@class='gamePointsBlock'])[" + c + "]")).getText();
					 ...
					 assertTrue(actual.equals("$100") || actual.equals("$200") || actual.equals("$300") || actual.equals("$400") || actual.equals("$500"));
				}
