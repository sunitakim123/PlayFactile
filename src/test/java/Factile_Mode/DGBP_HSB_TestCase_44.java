...
public class DGBP_HSB_TestCase_44 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_44.class.getName());
	...
	@Test
	public void TC_44_Verify_wager_submission_Zerot_by_player() throws InterruptedException, IOException {
