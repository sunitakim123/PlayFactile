...
public class DGBP_HSB_TestCase_8  extends Base{
	WebDriver driver;
	WebDriver driver1;
	WebDriverWait wait, wait1;
	int int2;
	String s6, s7, GameName, twitterLink, PintrestLink, t1, p1, parent, expectedValue, actualValue;
	String ElementNotGoingToVisible;
	Actions act;
	
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_8.class.getName());
	...
	@Test
	public void TC_8_Verify_Hide_category_with_Points_When_Unchecked_At_Global_Settings() throws InterruptedException, IOException {
	...
	public void modeaterscreen() throws InterruptedException
	{
		...
		if(!driver.findElement(By.xpath("//div[@id='gameSettingSection']//input[@id='categoryAndPoint']")).isSelected())
		{System.out.println("nothing to do");
		}
		else
		{
			act = new Actions(driver);
			act.moveToElement(driver.findElement(By.xpath("//div[@id='gameSettingSection']//input[@id='categoryAndPoint']"))).click().perform();;
		
		}
		Log.info("At customization page>> UnCheck Hide Category with Points>> ");
	} 
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				Thread.sleep(3000);
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@class='playNowButton']")));
				driver.findElement(By.xpath("//span[@class='playNowButton']")).click();
				Thread.sleep(3000);
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@data-numteams='2']")));
				...
				//driver1.findElement(By.xpath("//button[@class='btn joinBtn yellowBG mt-4 mb-4']")).click();//button[@class='btn joinBtn yellowBG mt-4 mb-4']
				Thread.sleep(2000);
				...
				WebElement obj2	  =	driver1.findElement(By.xpath("//*[@id='mainGameBoard']/div[1]/div/div[2]/p"));
				actualValue = obj2.getText();
