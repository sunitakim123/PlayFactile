...
public class DGBP_HSB_TestCase_45 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_45.class.getName());
	...
	@Test
	public void TC_45_Verify_Skip_wager_by_modrator() throws InterruptedException, IOException {
...
/*
	...
	driver.switchTo().window(driver.getWindowHandle());
	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("(//h4[@id='skipWagers'])[1]")));
	driver.findElement(By.xpath("(//h4[@id='skipWagers'])[1]")).click();
	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//button[@class='swal-button swal-button--confirm btn-success swal-button--danger']")));
