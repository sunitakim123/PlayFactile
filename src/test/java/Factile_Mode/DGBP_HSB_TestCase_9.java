...
public class DGBP_HSB_TestCase_9 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_9.class.getName());
	...
	@Test
	public void TC_9_Verify_Hide_category_with_Points_When_checked_At_Global_Settings()
