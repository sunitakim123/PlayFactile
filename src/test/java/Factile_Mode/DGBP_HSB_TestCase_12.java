...
public class DGBP_HSB_TestCase_12 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_12.class.getName());
	...
	@Test
	public void TC_12_Verify_Turn_of_Tag_Name_when_checked_At_Global_Settings() throws InterruptedException, IOException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[@id='settings']")));
	...
	public void modeaterscreen() throws InterruptedException {
		...
		if (driver.findElement(By.xpath("//div[@id='gameSettingSection']//input[@id='nameTags']")).isSelected()) {
			...
			act.moveToElement(driver.findElement(By.xpath("//div[@id='gameSettingSection']//input[@id='nameTags']")))
					.click().perform();
			;

		}
		Log.info("At customization page>> Check Turn off tag name>> ");
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				Thread.sleep(2000);
				try {
					WebElement PlayerNameAtPlayerScreen = driver1
							.findElement(By.xpath("//div[@class='m-0 p-0 col-12']/span"));
				} catch (NoSuchElementException e) {
					System.out.println("Tag name not  not visible on player screen>>" + e.toString());
				}
			}
