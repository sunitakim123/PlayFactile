...
public class DGBP_HSB_TestCase_46 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_46.class.getName());
	...
	@Test
	public void TC_46_Verify_wager_submit_by_moderator_is_full_amount() throws InterruptedException, IOException {
...
*/
	...
	driver.switchTo().window(driver.getWindowHandle());
	Thread.sleep(2000);
	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//div[@class='characterPodium']//img")));
