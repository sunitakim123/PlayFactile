...
public class DGBP_HSB_TestCase_49 extends Base {
	WebDriver driver;
	WebDriver driver1;
	...
	public static Logger Log = LogManager.getLogger(DGBP_HSB_TestCase_49.class.getName());
	...
	@Test
	public void TC_49_Verify_Final_factile_Answer_text_box_with_valid_characters() throws InterruptedException, IOException {
	...
	public void PlayerScreen() throws InterruptedException, IOException {
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				System.out.println("wager submit by player="+value);
				...
				wait1.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath("//textarea[@placeholder='Enter Answer']")));
				String expectedtext= "testing data submitted";
