...
public class DGBP_HSB_TestCase_3  extends Base{
	...
	private static String filePath = System.getProperty("user.dir") + "\\src\\main\\java\\images\\backgroundimage1.jpg";
	...
	@Test
	public void Verify_Uploaded_BackgroundImage_at_Player_screen() throws InterruptedException, IOException {
		...
		if (s1.equalsIgnoreCase(s5)) {
			...
			VerifyuploadedBackgroundimageatPlayerScreen();
	...
	public void uploadBAckgroundimageAtModeraterScreen() throws InterruptedException {
		...
		*/
		...
		Thread.sleep(10000);
		//wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//*@id='gameDesignSection']//input[@cLass='backgroundImageBtn'])[last()]")));
	...
	public void VerifyuploadedBackgroundimageatPlayerScreen() throws InterruptedException, IOException {
		Thread.sleep(2000);
