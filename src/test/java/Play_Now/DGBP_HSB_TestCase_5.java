...
public class DGBP_HSB_TestCase_5  extends Base{
	WebDriver driver;
	WebDriver driver1;
	...
	@Test
	public void Verify_Hide_Social_Media_Link_on_Gameboard_at_ModeaterScreen() throws InterruptedException, IOException {
	...
	public void Hide_SMO_Links_A_tModrater_Screen_Gameboard() throws InterruptedException, IOException {
		Thread.sleep(2000);
			...
			if(obj==true)
{
		...
		for (String child : allWindows) {
			if (!parent.equalsIgnoreCase(child)) {
				...
				driver1.manage().timeouts().setScriptTimeout(20, TimeUnit.SECONDS);Thread.sleep(3000);
...
try {
				 ...
				 e1 =driver.findElement(By.xpath("//span[@class='btn btn-social-icon btn-twitter redirectLink_blank']//span"));
				 e2= driver.findElement(By.xpath("//a[@class='btn btn-social-icon btn-pinterest']//span"));
				
}			

catch (NoSuchElementException e) {
	// log.debug("Impossible to click the pop-up. Reason: " + e.toString());
	System.out.println("Element visible " + e.toString());
}
